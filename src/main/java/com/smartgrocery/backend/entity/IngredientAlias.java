...
public class IngredientAlias {
    ...
    private IngredientCanonical canonical;

    @Column(name = "alias_text_raw", nullable = false, length = 200)
    private String aliasTextRaw;

    @Column(name = "alias_text_norm", nullable = false, length = 200)
    private String aliasTextNorm;

    @Column(name = "lang", nullable = false, length = 12)
    @Builder.Default
